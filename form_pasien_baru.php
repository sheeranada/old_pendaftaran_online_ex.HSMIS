...
$captcha = sprintf("%06d", mt_rand(100000, 999999));
...
<td valign="top">
	...
	<div align="center">
	<table border="0" width="353" height="247"  >
	...
	<?php 						
		...
		if($m=='captcha') { echo "CAPTCHA TIDAK SESUAI<br>"; } 							
	 ?>	 
	</b> 
		...
		<td>Tgl Lahir</td>
		<td>
		<input type="date" name="T5" size="20" style="width: 139; height: 32" value="<?php echo date('Y-m-d',strtotime($t5)) ?>"></td>
		</tr>
		<tr>
		<td>J.Kelamin</td>
		<td>
		...
		<td>
			<p align="left">
		<input name="T11" size="20" style="width: 139; height: 32"></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		<td>
			<table border="1" style="border-collapse: collapse" width="200" height="68" bordercolor="#CCCCCC" bordercolordark="#DBDBDB">
				<tr>
					<td background="images/captcha.png">
					<p align="center"><i><b>
					<font size="7" face="Book Antiqua" color="#FFFFFF"><?php echo $captcha; ?></font></b></i></td>
				</tr>
			</table>
		</td>
		</tr>
		...
		<td colspan="2">
		<p align="center"><br>
		<input type="submit" value="Simpan" name="B1" style="width: 154; height: 40"></p></td>
		</tr>
		</div>
</form>
<p align="center">&nbsp;</p>
